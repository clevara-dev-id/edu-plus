...
import './radioButtonFive.css';
import { Container, Row, Col } from 'react-bootstrap';

const RadioButtonFive = props => {
    const [icon,setIcon]=useState('');
    return (
        <>
            <Container id="radioFiveid">
                <div className="radio-toolbar">
                    <Row><Col className="radioTitle">Pilih Jenjang Pendidikan</Col></Row>
                    <Row>
                        <Col className="bsjpFive" xs={6}>
                            <Input 
                        ...
                        <Col className="bsjpFive" xs={6} style={{paddingLeft: '5px'}}>
                            <Input 
                        ...
                        <Col className="bsjpFive" xs={6} style={{paddingLeft: '5px'}}>
                            ...
                            <label htmlFor="inputUniv" >
                                <div>
                                    <Icon 
                                        font="FontAwesome"
                                        name={icon === 'univ' ? 'check-circle' : "circle-o"} 
                                        color='black' 
                                        size={24} 
                                    />
                                    <div>Universitas</div>
...
RadioButtonFive.propTypes  = {
    onClick : PropTypes.func
}

export default RadioButtonFive
