...
const RadioButtonTwoDesktopRegister = props =>{  
    const [icon,setIcon]=useState('');
    return(
        <>
            <Container id="radioButtonTwoDesktopRegisterContainer">
                <div className="radio-toolbarTwo">
                    <Row><Col className="radioTitle">{props.title}</Col></Row>
                    <Row>
                        <Col className="bsjpTwo" lg={2}>
                            <Input 
                        ...
                        <Col className="bsjpTwo" lg={2} style={{paddingLeft : "5px", paddingRight : "5px"}} id="midConten">
                            <Input 
...
RadioButtonTwoDesktopRegister.propTypes  = {
    onClick : PropTypes.func
}

export default RadioButtonTwoDesktopRegister;
