...
import './titlebottomdesktoptertiary.css'

const TitleBottomDesktopTertiary = props => {
    return (
        <>
            <Container id="bottomTitleDesktopTertiaryContainer">
                <Row>
                    <Col>
...
TitleBottomDesktopTertiary.propTypes = {
...
export default TitleBottomDesktopTertiary;