...
import './mobiledescriptionwithicon.css'

const MobileDescriptionWithIcon = props => {
    return(
        <>
            <Container id="mobileDescriptionWithIconContainer">
...
MobileDescriptionWithIcon.propTypes = {
    phone : PropTypes.string,
    mail  : PropTypes.string,
    web   : PropTypes.string,
}

export default MobileDescriptionWithIcon;